export const enUS = {
  ...
  models: {
    ...
    assignmentAutoSave: "Changes save automatically",
    assignmentClear: "Clear {{model}} selection",
    assignmentUnavailable: "This model is no longer available. Choose another model.",
    assignmentSaveFailed: "Could not save this change. Your previous settings are unchanged.",
