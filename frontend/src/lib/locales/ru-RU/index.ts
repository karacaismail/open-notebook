...
export const ruRU = {
  ...
  models: {
    ...
    assignmentAutoSave: "Изменения сохраняются автоматически",
    assignmentClear: "Очистить выбор {{model}}",
    assignmentUnavailable: "Эта модель больше недоступна. Выберите другую модель.",
    assignmentSaveFailed: "Не удалось сохранить изменение. Предыдущие настройки сохранены.",
