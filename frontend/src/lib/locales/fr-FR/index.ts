...
export const frFR = {
  ...
  models: {
    ...
    assignmentAutoSave: "Les modifications sont enregistrées automatiquement",
    assignmentClear: "Effacer la sélection de {{model}}",
    assignmentUnavailable: "Ce modèle n’est plus disponible. Choisissez un autre modèle.",
    assignmentSaveFailed: "Impossible d’enregistrer cette modification. Vos paramètres précédents sont conservés.",
