...
export const bnIN = {
  ...
  models: {
    ...
    assignmentAutoSave: "পরিবর্তনগুলি স্বয়ংক্রিয়ভাবে সংরক্ষিত হয়",
    assignmentClear: "{{model}} নির্বাচন মুছুন",
    assignmentUnavailable: "এই মডেলটি আর উপলব্ধ নেই। অন্য একটি মডেল বেছে নিন।",
    assignmentSaveFailed: "পরিবর্তনটি সংরক্ষণ করা যায়নি। আগের সেটিংস অপরিবর্তিত আছে।",
