...
export const esES = {
  ...
  models: {
    ...
    assignmentAutoSave: "Los cambios se guardan automáticamente",
    assignmentClear: "Borrar la selección de {{model}}",
    assignmentUnavailable: "Este modelo ya no está disponible. Elige otro modelo.",
    assignmentSaveFailed: "No se pudo guardar el cambio. Se conserva la configuración anterior.",
