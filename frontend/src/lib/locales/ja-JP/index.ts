...
export const jaJP = {
  ...
  models: {
    ...
    deleteModel: "モデルを削除",
    assignmentAutoSave: "変更は自動的に保存されます",
    assignmentClear: "{{model}}の選択を解除",
    assignmentUnavailable: "このモデルは利用できなくなりました。別のモデルを選択してください。",
    assignmentSaveFailed: "変更を保存できませんでした。以前の設定は維持されています。",
