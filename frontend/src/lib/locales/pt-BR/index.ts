...
export const ptBR = {
  ...
  models: {
    ...
    assignmentAutoSave: "As alterações são salvas automaticamente",
    assignmentClear: "Limpar a seleção de {{model}}",
    assignmentUnavailable: "Este modelo não está mais disponível. Escolha outro modelo.",
    assignmentSaveFailed: "Não foi possível salvar a alteração. As configurações anteriores foram mantidas.",
