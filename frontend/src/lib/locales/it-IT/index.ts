...
export const itIT = {
  ...
  models: {
    ...
    assignmentAutoSave: "Le modifiche vengono salvate automaticamente",
    assignmentClear: "Cancella la selezione di {{model}}",
    assignmentUnavailable: "Questo modello non è più disponibile. Scegli un altro modello.",
    assignmentSaveFailed: "Impossibile salvare la modifica. Le impostazioni precedenti sono conservate.",
