...
export type PreparationPlan = {version:string;parts:number;source_bytes:number;source_sha256:string;coverage_verified:boolean;semantic_lossless:false;status:string;minimum_calls:number;completed_calls?:number}
