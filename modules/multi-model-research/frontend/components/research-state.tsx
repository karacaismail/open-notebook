...
export const attentionStates = ['failed', 'interrupted', 'context_limit', 'login_required', 'verification_required', 'quota_wait', 'research_unavailable', 'browser_changed', 'browser_unavailable', 'submission_uncertain']
