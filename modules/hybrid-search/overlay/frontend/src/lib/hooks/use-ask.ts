...
import { AskStreamEvent, RetrievalDiagnostics } from '@/lib/types/search'
        ...
        for (const line of lines) {
          if (line.startsWith('data: ')) {
            try {
              ...
              } else if (data.type === 'retrieval' && data.timings && data.warnings) {
                setState(prev => ({...prev, retrieval:[...prev.retrieval,data as RetrievalDiagnostics]}))
