...
export function AppSidebar() {
  ...
  const activeHref = navigation.flatMap(section => section.items).filter(item => pathname === item.href || pathname?.startsWith(`${item.href}/`)).sort((a,b) => b.href.length-a.href.length)[0]?.href
